...
$resourcegroup_name = "deloitteauits2"	 				# Resource Group Name
$location_name = "southeastasia" 							# Location Name
$storage_account_name = "deloitteaustorage2"				# Storage Account Name
$storage_account_type="Standard_LRS"					# Storage Account Type
$domain_name = "deloitteauits2"							# Domain Name
$availability_set_name = "deloitteavset2"				# Availability Set Name
$virtual_network_name = "deloitteauvirtualnetwork2"		# Virtual Network Name
$public_ip_name = "deloittepublicip2"					# Public IP Name
$load_balancer_name = "deloitteloadbalancer2"			# Load Balancer Name
