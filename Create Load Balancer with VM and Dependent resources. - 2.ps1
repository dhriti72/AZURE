...
$resourcegroup_name = "deloitteauits"	 				# Resource Group Name
$location_name = "westeurope" 							# Location Name
$storage_account_name = "deloitteaustorage"				# Storage Account Name
$storage_account_type="Standard_LRS"					# Storage Account Type
$domain_name = "deloitteauits"							# Domain Name
$availability_set_name = "deloitteavset"				# Availability Set Name
$virtual_network_name = "deloitteauvirtualnetwork"		# Virtual Network Name
$public_ip_name = "deloittepublicip"					# Public IP Name
$load_balancer_name = "deloitteloadbalancer"			# Load Balancer Name
